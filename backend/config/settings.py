"""
Django settings for rosatom_nko project.
"""
...
ALLOWED_HOSTS = ['*']  # В production указать конкретные хосты
...
# Отключаем APPEND_SLASH для API endpoints
# DRF сам обрабатывает слэши корректно
APPEND_SLASH = False
