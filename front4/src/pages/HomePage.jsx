...
export default function HomePage(){
    ...
    return (
        <div className="space-y-0 smooth-scroll">
            {/* Hero Section */}
            <section className="relative py-12 md:py-20 overflow-hidden bg-white pattern-rosatom">
                <div className="container-max relative z-10">
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
                        {/* Левая часть - текст */}
                        <div className={`space-y-4 ${isVisible ? 'fade-in-up' : 'opacity-0'}`}>
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight" style={{ color: '#1a2165', letterSpacing: '-0.03em' }}>
                                Добрые дела Росатома —<br />
                                все инициативы вашего города<br />
                                в одном месте
                            </h1>
            ...
            {/* Feature Cards */}
            <section className="bg-white py-8 md:py-12 -mt-8 md:-mt-12">
