...
export default function MaterialDetailsPage() {
    ...
    useEffect(() => {
        if (user && material) {
            // Проверяем, сохранен ли материал в библиотеке
            // Это можно сделать через API или из данных пользователя
            const library = user.library || []
            setIsSaved(library.includes(material.id))
        }
    }, [user, material])
    ...
    const loadMaterial = async () => {
        ...
        try {
            ...
            showToast('Ошибка загрузки материала', 'error')
        } finally {
            setLoading(false)
        }
    }
        ...
        return (
            <div className="max-w-4xl mx-auto">
                <div className="card text-center py-12">
                    <h2 className="text-2xl font-bold mb-4" style={{ color: '#1a2165' }}>Материал не найден</h2>
            ...
            <div className="card mb-6">
                <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                        <h1 className="text-3xl font-bold mb-4" style={{ color: '#1a2165' }}>{material.title}</h1>
