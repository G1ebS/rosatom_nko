...
export default function NGOListPage(){
    ...
    const filteredList = useMemo(() => {
        return ngos.filter(n => {
            ...
            // Показываем только одобренные НКО (для обычных пользователей)
            // Администраторы увидят все через админ-панель
            const statusMatch = !n.status || n.status === 'approved'
            return cityMatch && categoryMatch && searchMatch && statusMatch
        })
